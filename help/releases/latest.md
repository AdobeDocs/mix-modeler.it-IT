...
|---|---|---|---|
| **[!UICONTROL Dataset rules]** | Tabella delle regole del set di dati aggiornata. È possibile cercare una o più regole del set di dati e visualizzarle, modificarle o eliminarle direttamente dalla tabella. | 13 gennaio 2026 | 13 gennaio 2026 |
