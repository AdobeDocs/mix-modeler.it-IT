...
| ---------------------- | ----------|
| **[!UICONTROL Dataset]** | Nome del set di dati.  Utilizza ![Altro](/help/assets/icons/More.svg) per selezionare le azioni per un set di dati. Puoi eseguire le seguenti operazioni:<ul><li>![Anteprima](/help/assets/icons/Preview.svg) **[!UICONTROL View]** per visualizzare la configurazione delle regole del set di dati. Tutti i campi sono disabilitati.</li><li>![Modifica](/help/assets/icons/Edit.svg) **[!UICONTROL Edit]** per modificare la configurazione delle regole del set di dati.</li><li>![Elimina](/help/assets/icons/Delete.svg) **[!UICONTROL Delete]** per eliminare la configurazione delle regole del set di dati. Viene richiesto di confermare l’eliminazione nella finestra di dialogo Elimina set di dati. Selezionare **[!UICONTROL Delete]** per eliminare definitivamente la configurazione della regola del set di dati.</li><ul> |
| **[!UICONTROL Source]** | L’origine del set di dati: Adobe Analytics, Eventi esperienza, Riepilogo (aggregato) o Eventi esperienza del consumatore. |
| **[!UICONTROL Schema]** | Schema a cui è conforme il set di dati. È possibile selezionare rapidamente il nome dello schema per aprire lo schema in una nuova scheda nell&#39;editor schema in ![Schema](/help/assets/icons/Schemas.svg) [Schemi](../ingest-data/schemas.md). |
| **[!UICONTROL Granularity]** | Granularità dei dati nel set di dati. I valori possibili sono Giornaliero, Settimanale, Mensile o Annuale. |
| **[!UICONTROL Start of the week]** | Specifica quale giorno della settimana viene considerato come inizio di una nuova settimana per il set di dati specifico. |
| **[!UICONTROL Status]** | Stato del campo: ![StatusGray](/help/assets/icons/StatusGray.svg) Draft o ![StatusGreen](/help/assets/icons/StatusGreen.svg) Active |
| **[!UICONTROL Last modified]** | Dati e ora dell’ultima modifica della regola del set di dati. |
