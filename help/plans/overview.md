...
1. Viene visualizzata una tabella dei piani correnti e del relativo stato.
   ...
   |---|---|
   | **[!UICONTROL Name]** | Nome del piano |
   | **[!UICONTROL Model]** | Modello utilizzato come base per il piano. |
   | **[!UICONTROL Date range]** | Intervallo di date completo per un piano. |
   | **[!UICONTROL Budget]** | Budget totale per un piano. |
   | **[!UICONTROL Plan target]** | La metrica di destinazione definita per un piano basato su destinazione. |
   | **[!UICONTROL Forecasted return]** | [rendimento previsto](/help/main-guide/glossary.md) per un piano |
   | **[!UICONTROL Forecasted ROI]** | [ROI previsto](/help/main-guide/glossary.md) per un piano. |
   | **[!UICONTROL Forecasted conversion]** | [conversione prevista](/help/main-guide/glossary.md) per un piano |
   | **[!UICONTROL Forecasted CPA]** | Il [CPA previsto](/help/main-guide/glossary.md)per un piano |
   | **[!UICONTROL Status]** | Stato di un piano:<br/>![StatusOrange](/help/assets/icons/StatusOrange.svg) **[!UICONTROL Failed]**,<br/>![StatusBlue](/help/assets/icons/StatusBlue.svg) **[!UICONTROL Processing]** o<br/>![StatusGreen](/help/assets/icons/StatusGreen.svg) **[!UICONTROL Complete]**. |
